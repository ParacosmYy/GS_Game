...
- 先把一个人物做精，再做其他人物。
- 先把 Ryo 做成 baseline，再把 Kyo / Iori 和流程 UI 做成可复制的 Phase 2 样板。
...
因此当前阶段先收敛到 Ryo baseline，再把 Kyo / Iori 和流程仪式感推进到可复制模板。

当前最重要的推进顺序见 [KOF 差距矩阵](kof-gap-matrix.md)。本计划负责告诉我们“Ryo baseline 是什么”，差距矩阵负责告诉我们“Phase 2 先补哪一块最值钱”。
...
Phase 1 基线达到以下条件后，Phase 2 可继续扩展和优化 Kyo/Iori：
