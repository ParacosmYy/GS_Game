...
| 维度 | 满分 | 当前 | 现状 |
| --- | ---: | ---: | --- |
| 角色美术 | 200 | 25 | Ryo像素帧42/42状态覆盖+Kyo/Iori idle+walk+attack(ABCD)+crouch+jump+hurt+knockdown+block高分辨率像素帧(48x72 SNK风格)全状态覆盖+Iori 64x80 WIN pose双帧(咬手套/狂笑)+Kyo/Iori 64x80 win+48x48 HUD肖像(sizedPortraits)+Ryo四尺寸肖像完整闭环 |
