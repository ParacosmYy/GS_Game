...
| 维度 | 满分 | 当前 | 现状 |
| --- | ---: | ---: | --- |
| 角色美术 | 200 | 20 | Ryo像素帧42/42状态覆盖+Kyo idle+walk+attack(ABCD)+crouch+jump+damage高分辨率像素帧(48x72 SNK风格)+Iori idle高分辨率像素帧起始+Kyo/Iori 64x80 win+48x48 HUD肖像(sizedPortraits)+Ryo四尺寸肖像完整闭环(select/vs/hud/win) |
