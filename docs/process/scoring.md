...
| 游戏流程 | 100 | 31 | 完整街机流程+3v3+训练模式+MATCH POINT+暂停菜单+OPTIONS+回合开始持续提示+KO结果HP对比+街机模式对手递进+舞台轮换+街机得分系统+MATCH POINT回合开始提示+NEXT STAGE对手肖像预览+宿敌对决特殊对话(Kyo↔Iori等13组)+FINAL ROUND决胜局播报+街机完成成绩总结(得分/连段/完美/伤害+段位评级) |
