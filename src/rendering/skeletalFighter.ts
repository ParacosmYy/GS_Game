...
import { drawFistGlow, getAttackAccentGlow } from './skeletalVictory.js';
export { drawVictoryPose } from './skeletalVictory.js';
...
// drawFistGlow and getAttackAccentGlow extracted to skeletalVictory.ts

// drawVictoryPose extracted to skeletalVictory.ts, re-exported via import above
