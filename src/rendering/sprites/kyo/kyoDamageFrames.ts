...
// ===== BLOCK (2 frames) =====
// Guard stance — arms raised in defense, body braced

// Frame 0: Guard snap — arms raised to block, body bracing
const BL0: number[][] = [
  // Hair/head
  r('.................132'),
  r('................135531'),
  ...
  r('112389b91'),
  r('112c9b91'),
  // Torso — arms crossed in front for block
  r('.1c8a11d9b1'),
  r('.1c8a11d9b1'),
  r('.1c8a11d9b1'),
  r('.1c8a11d9b1'),
  ...
  r('..1n1.1n1'),
  r('.1kl11kl1'),
  // Legs — braced stance, wider than idle
  r('1klm1klm1'),
  r('1klm1klm1'),
  r('.1klmklm1'),
  r('.1klmkl1'),
...
// Frame 1: Guard held — sustained blocking
const BL1: number[][] = BL0.map(row => [...row]);

export const KYO_BLOCK_FRAMES: PixelFrame[] = [BL0, BL1].map(pixels => ({
  width: W,
  height: 72,
  palette: PALETTE,
  pixels,
