...
export function hasHighResFrame(
  ...
  return renderer.has(state, currentAttack, vx, facing);
}
...
export function getResolvedFrameKey(
  ...
  return renderer.resolveKey(state, currentAttack, vx, facing);
}
...
export function drawHighResFrame(
  ...
  if (charId !== 'ryo') return false;
  return renderer.draw(ctx, state, stateAge, x, y, facing, currentAttack, vx);
}
...
export function drawHighResAfterimage(
  ...
  if (charId !== 'ryo') return false;
  return renderer.drawAfterimage(ctx, state, stateAge, x, y, facing, currentAttack, vx, tint, alpha);
}

export const drawRyoWinPose = renderer.drawWinPose;
