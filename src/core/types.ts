...
export enum AttackType {
  ...
  // 椎拳崇命令通常技 (Kensou Command Normals)
  KENSOU_BAKYAKU = 'KENSOU_BAKYAKU',                   // →+B Bakyaku (overhead)
  KENSOU_KAKUHI = 'KENSOU_KAKUHI',                     // ↘+D Kakuhi (low)
  // 坂崎琢磨命令通常技 (Takuma Command Normals)
  TAKUMA_FUU_GA = 'TAKUMA_FUU_GA',                     // →+A Fuu Ga (upper)
  TAKUMA_GOUSOU = 'TAKUMA_GOUSOU',                     // →+B Gousou (overhead)
  ...
  RYO_KOOUKEN_D = 'RYO_KOOUKEN_D',   // 虎煌拳D版 ↓↘→+D (heavy projectile)
  RYO_HIO_HACKER = 'RYO_HIO_HACKER', // 氷果斬 →+A (dash strike)
  RYO_ZANRETSU_KEN = 'RYO_ZANRETSU_KEN', // 斩裂拳 ←↙↓+P (multi-punch)
  ...
  // 椎拳崇必杀技 (Kensou Specials)
  KENSOU_CHOU_KYUU_DAN = 'KENSOU_CHOU_KYUU_DAN',       // QCF+A Chou Kyuu Dan (weak projectile)
  KENSOU_CHOU_KYUU_DAN_C = 'KENSOU_CHOU_KYUU_DAN_C',   // QCF+C Chou Kyuu Dan (strong projectile)
  KENSOU_RYURENGA_TEN = 'KENSOU_RYURENGA_TEN',         // QCB+A Ryurenga Tentei (weak rush)
  KENSOU_RYURENGA_CHI = 'KENSOU_RYURENGA_CHI',         // QCB+C Ryurenga Tentei (strong rush)
  KENSOU_RYUSOU_GEKI = 'KENSOU_RYUSOU_GEKI',           // HCF+P Ryusou Geki (command grab)
  // 坂崎琢磨必杀技 (Takuma Specials)
  TAKUMA_KO_OU_KEN = 'TAKUMA_KO_OU_KEN',               // QCF+A Ko Ou Ken (weak projectile)
  TAKUMA_KO_OU_KEN_C = 'TAKUMA_KO_OU_KEN_C',           // QCF+C Ko Ou Ken (strong projectile)
  TAKUMA_HAOH_SHOU_KOU_KEN = 'TAKUMA_HAOH_SHOU_KOU_KEN', // FDF+P Haoh Shou Kou Ken
  TAKUMA_HIEN_SHIPPUU = 'TAKUMA_HIEN_SHIPPUU',         // QCB+K Hien Shippuu Kyaku (flying kick)
  ...
  DM_SHIN_CHOU_KYUU_DAN = 'DM_SHIN_CHOU_KYUU_DAN',     // Shin Chou Kyuu Dan DM (Kensou)
  DM_RYUKO_RANBU_TAKUMA = 'DM_RYUKO_RANBU_TAKUMA',     // Ryuko Ranbu DM (Takuma)
  ...
  SDM_HIGH_ANGLE_GEYSER = 'SDM_HIGH_ANGLE_GEYSER', // High Angle Geyser SDM (Terry)
  SDM_PHOENIX_KICK = 'SDM_PHOENIX_KICK',     // 鳳凰脚SDM (Kim)
  SDM_PHOENIX_HITEN = 'SDM_PHOENIX_HITEN',   // 鳳凰天舞脚SDM (Kim)
  ...
  HSDM_OROCHINAGI = 'HSDM_OROCHINAGI',        // 大蛇薙HSDM (Kyo)
  HSDM_YAOTOME = 'HSDM_YAOTOME',              // 八稚女HSDM (Iori)
  ...
  SDM_SHIN_CHOU_KYUU_DAN = 'SDM_SHIN_CHOU_KYUU_DAN',  // Shin Chou Kyuu Dan SDM (Kensou)
  SDM_RYUKO_RANBU_TAKUMA = 'SDM_RYUKO_RANBU_TAKUMA',  // Ryuko Ranbu SDM (Takuma)
...
export enum GamePhase {
  ...
  STAGE_INTRO = 'STAGE_INTRO', // Stage name reveal before round start
