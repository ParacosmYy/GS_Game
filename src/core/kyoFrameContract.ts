...
const KYO_CFG: FrameBuilderConfig = { characterId: 'kyo', pixelKeys: PIXEL_KEYS, tpf: TPF };
...
const idle: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'idle', 8),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const walk_forward: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'walk_forward', 6),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const walk_backward: ActionContract = {
  ...
  state: FighterState.WALK,
  attackType: null,
  frames: makeFrames(KYO_CFG, 'walk_backward', 6),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const jump: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'jump', 12),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const run: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'run', 6),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const backdash: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'backdash', 8),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const roll: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'roll', 10),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const back_roll: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'back_roll', 10),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const crouch: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'crouch', 4),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const block: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'block', 6),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const dizzy: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'dizzy', 12),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const guard_crush: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'guard_crush', 10),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const max_mode: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'max_mode', 8),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const taunt: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'taunt', 10),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const win: ActionContract = {
  ...
  state: FighterState.IDLE,
  attackType: null,
  frames: makeFrames(KYO_CFG, 'win', 12),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const throw_action: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'throw_action', 10),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const hurt: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'hurt', 10),
  hitLevel: 'MID',
  knockdown: false,
  startup: 0,
  active: 0,
...
const knockdown: ActionContract = {
  ...
  attackType: null,
  frames: makeFrames(KYO_CFG, 'knockdown', 16),
  hitLevel: 'MID',
  knockdown: true,
  startup: 0,
  active: 0,
...
const stand_a: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'stand_a', 5, 3, 5, AttackType.STAND_A, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: false,
  startup: 5,
  active: 3,
...
const stand_b: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'stand_b', 5, 4, 7, AttackType.STAND_B, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: false,
  startup: 5,
  active: 4,
...
const stand_c: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'stand_c', 7, 4, 10, AttackType.STAND_C, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: false,
  startup: 7,
  active: 4,
...
const stand_d: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'stand_d', 8, 5, 12, AttackType.STAND_D, ATTACK_FRAMES),
  hitLevel: 'HIGH',
  knockdown: false,
  startup: 8,
  active: 5,
...
const close_a: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'close_a', 4, 3, 5, AttackType.CLOSE_A, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: false,
  startup: 4,
  active: 3,
...
const close_b: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'close_b', 4, 3, 6, AttackType.CLOSE_B, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: false,
  startup: 4,
  active: 3,
...
const close_c: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'close_c', 5, 4, 8, AttackType.CLOSE_C, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: false,
  startup: 5,
  active: 4,
...
const close_d: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'close_d', 6, 5, 10, AttackType.CLOSE_D, ATTACK_FRAMES),
  hitLevel: 'HIGH',
  knockdown: false,
  startup: 6,
  active: 5,
...
const crouch_a: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'crouch_a', 4, 3, 5, AttackType.CROUCH_A, ATTACK_FRAMES),
  hitLevel: 'LOW',
  knockdown: false,
  startup: 4,
  active: 3,
...
const crouch_b: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'crouch_b', 5, 4, 6, AttackType.CROUCH_B, ATTACK_FRAMES),
  hitLevel: 'LOW',
  knockdown: false,
  startup: 5,
  active: 4,
...
const crouch_c: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'crouch_c', 6, 4, 9, AttackType.CROUCH_C, ATTACK_FRAMES),
  hitLevel: 'LOW',
  knockdown: false,
  startup: 6,
  active: 4,
...
const crouch_d: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'crouch_d', 7, 5, 11, AttackType.CROUCH_D, ATTACK_FRAMES),
  hitLevel: 'LOW',
  knockdown: true,
  startup: 7,
  active: 5,
...
const air_a: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'air_a', 4, 4, 4, AttackType.STAND_A, ATTACK_FRAMES),
  hitLevel: 'HIGH',
  knockdown: false,
  startup: 4,
  active: 4,
...
const air_c: ActionContract = {
  ...
  state: FighterState.AIR_ATTACK,
  attackType: AttackType.STAND_C,
  frames: makeAttackFrames(KYO_CFG, 'air_c', 6, 5, 5, AttackType.STAND_C, ATTACK_FRAMES),
  hitLevel: 'HIGH',
  knockdown: false,
  startup: 6,
  active: 5,
...
const air_d: ActionContract = {
  ...
  state: FighterState.AIR_ATTACK,
  attackType: AttackType.STAND_D,
  frames: makeAttackFrames(KYO_CFG, 'air_d', 6, 5, 5, AttackType.STAND_D, ATTACK_FRAMES),
  hitLevel: 'HIGH',
  knockdown: false,
  startup: 6,
  active: 5,
...
const kyo_75kai: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'kyo_75kai', 14, 4, 14, AttackType.KYO_75KAI, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: false,
  startup: 14,
  active: 4,
...
const kyo_75kai_2: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'kyo_75kai_2', 7, 4, 14, AttackType.KYO_75KAI_2, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: true,
  startup: 7,
  active: 4,
...
const kyo_red_kick: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'kyo_red_kick', 19, 5, 33, AttackType.KYO_RED_KICK, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: true,
  startup: 19,
  active: 5,
...
const cmd_gofu_you: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'cmd_gofu_you', 12, 5, 18, AttackType.CMD_GOFU_YOU, ATTACK_FRAMES),
  hitLevel: 'HIGH',
  knockdown: false,
  startup: 12,
  active: 5,
...
const cmd_88shiki: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'cmd_88shiki', 10, 6, 20, AttackType.CMD_88SHIKI, ATTACK_FRAMES),
  hitLevel: 'LOW',
  knockdown: false,
  startup: 10,
  active: 6,
...
const cmd_naraku: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'cmd_naraku', 8, 5, 16, AttackType.CMD_NARAKU, ATTACK_FRAMES),
  hitLevel: 'HIGH',
  knockdown: true,
  startup: 8,
  active: 5,
...
const kyo_oniyaki: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'kyo_oniyaki', 6, 5, 38, AttackType.KYO_ONIYAKI, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: true,
  startup: 6,
  active: 5,
...
const kyo_oniyaki_c: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'kyo_oniyaki_c', 6, 10, 48, AttackType.KYO_ONIYAKI_C, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: true,
  startup: 6,
  active: 10,
...
const kyo_yamibarai: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'kyo_yamibarai', 10, 20, 30, AttackType.KYO_YAMIBARAI, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: false,
  startup: 10,
  active: 20,
...
const kyo_yamibarai_c: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'kyo_yamibarai_c', 11, 22, 28, AttackType.KYO_YAMIBARAI_C, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: false,
  startup: 11,
  active: 22,
...
const kyo_aragami: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'kyo_aragami', 12, 4, 18, AttackType.KYO_ARAGAMI, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: false,
  startup: 12,
  active: 4,
...
const kyo_dokugami: ActionContract = {
  ...
  frames: makeAttackFrames(KYO_CFG, 'kyo_dokugami', 18, 4, 21, AttackType.KYO_DOKUGAMI, ATTACK_FRAMES),
  hitLevel: 'MID',
  knockdown: false,
  startup: 18,
  active: 4,
...
const dm_orochinagi_frames = makeAttackFrames(KYO_CFG, 'dm_orochinagi', 18, 30, 28, AttackType.DM_OROCHINAGI, ATTACK_FRAMES);
...
const sdm_orochinagi_frames = makeAttackFrames(KYO_CFG, 'sdm_orochinagi', 20, 38, 29, AttackType.SDM_OROCHINAGI, ATTACK_FRAMES);
