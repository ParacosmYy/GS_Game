...
export const HITBOX_OFFSETS: Record<string, HitboxOffset> = {
  ...
  // Benimaru specials
  BENIMARU_JACKKNIFE_KICK: { offsetX: 45, offsetY: -90, width: 60, height: 45 },
  BENIMARU_FLYING_DRILL: { offsetX: 30, offsetY: -60, width: 50, height: 50 },
  BENIMARU_RAIJINKEN: { offsetX: 50, offsetY: -100, width: 65, height: 55 },
  BENIMARU_RAIJINKEN_C: { offsetX: 55, offsetY: -100, width: 75, height: 60 },
  BENIMARU_IAI_GERI: { offsetX: 50, offsetY: -80, width: 70, height: 40 },
  BENIMARU_IAI_GERI_D: { offsetX: 55, offsetY: -80, width: 75, height: 45 },
  BENIMARU_HANDOU_SANDAN_GERI: { offsetX: 50, offsetY: -90, width: 70, height: 50 },
  BENIMARU_SHINKUU_KATATEGOMA: { offsetX: 40, offsetY: -100, width: 60, height: 60 },
  BENIMARU_SHINKUU_KATATEGOMA_C: { offsetX: 45, offsetY: -100, width: 65, height: 65 },
  BENIMARU_COLLIDER: { offsetX: 30, offsetY: -70, width: 50, height: 60 },
  BENIMARU_SUPER_INAZUMA_KICK: { offsetX: 40, offsetY: -120, width: 60, height: 50 },
  BENIMARU_SUPER_INAZUMA_KICK_D: { offsetX: 45, offsetY: -130, width: 65, height: 55 },
  DM_BENIMARU_RAIKOUKEN: { offsetX: 50, offsetY: -110, width: 90, height: 80 },
  DM_GENEI_HURRICANE: { offsetX: 50, offsetY: -100, width: 85, height: 75 },
  SDM_BENIMARU_RAIKOUKEN: { offsetX: 55, offsetY: -115, width: 100, height: 90 },

  // Heidern specials
  HEIDERN_CROSS_CUTTER: { offsetX: 55, offsetY: -95, width: 60, height: 45 },
  HEIDERN_MOON_SLASHER: { offsetX: 45, offsetY: -110, width: 70, height: 55 },
  HEIDERN_NECK_ROLLER: { offsetX: 40, offsetY: -80, width: 65, height: 50 },
  ...
  // Yuri specials
  YURI_UPPER_BLOCK: { offsetX: 45, offsetY: -100, width: 55, height: 40 },
  YURI_LOWER_BLOCK: { offsetX: 50, offsetY: -50, width: 60, height: 35 },
  YURI_ORI: { offsetX: 40, offsetY: -80, width: 55, height: 45 },
  YURI_KO_OU_KEN: { offsetX: 55, offsetY: -90, width: 65, height: 50 },
  YURI_HAOH_SHO_KO_KEN: { offsetX: 60, offsetY: -95, width: 75, height: 55 },
  YURI_CHOU_UPPER: { offsetX: 45, offsetY: -110, width: 60, height: 55 },
  YURI_HYAKU_RETSU_BINTA: { offsetX: 40, offsetY: -85, width: 55, height: 45 },
  YURI_HIEN_HOU_OU_KYAKU: { offsetX: 50, offsetY: -90, width: 70, height: 50 },
  YURI_HISHOU_KUURETSU_ZAN: { offsetX: 45, offsetY: -85, width: 65, height: 50 },
  YURI_RAI_KEN: { offsetX: 50, offsetY: -90, width: 60, height: 50 },
  DM_YURI_HAOH_SHO_KO_KEN: { offsetX: 60, offsetY: -100, width: 85, height: 70 },
  DM_YURI_HIEN_HOU_OU_KYAKU: { offsetX: 50, offsetY: -95, width: 80, height: 65 },
