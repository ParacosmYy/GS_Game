...
import {
  ...
  IORI_ONIYAKI_FRAMES, IORI_ONIYAKI_C_FRAMES, IORI_KOTOTSUKI_FRAMES, IORI_KOTOTSUKI_D_FRAMES, IORI_KUZUKAZE_FRAMES,
...
export const ATTACK_FRAMES: AttackFrameTable = {
  ...
  [AttackType.IORI_AOIHANA_C]: IORI_AOIHANA_C_FRAMES,
  [AttackType.IORI_AOIHANA_C_2]: IORI_AOIHANA_C_2_FRAMES,
  [AttackType.IORI_AOIHANA_C_3]: IORI_AOIHANA_C_3_FRAMES,
  ...
  [AttackType.IORI_KOTOTSUKI_D]: IORI_KOTOTSUKI_D_FRAMES,
  ...
  [AttackType.SDM_OROCHINAGI]: SDM_OROCHINAGI_FRAMES,
  [AttackType.HSDM_OROCHINAGI]: HSDM_OROCHINAGI_FRAMES,
  [AttackType.DM_YATAGARASU]: DM_YATAGARASU_FRAMES,
  [AttackType.SDM_YATAGARASU]: SDM_YATAGARASU_FRAMES,
  [AttackType.HSDM_YAOTOME]: HSDM_YAOTOME_FRAMES,
