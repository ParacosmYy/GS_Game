...
export class CombatSystem {
  ...
  private resolveHit(attacker: Fighter, defender: Fighter, onHit?: HitCallback): void {
    ...
    if (atkName.startsWith('KYO_') || atkName.startsWith('IORI_') || atkName.startsWith('TERRY_')
      || atkName.startsWith('KIM_') || atkName.startsWith('RYO_') || atkName.startsWith('LEONA_') || atkName === AttackType.SPECIAL_UPPER
...
function guardGaugeDamage(attackType: AttackType): number {
  ...
  if (name.startsWith('KYO_') || name.startsWith('IORI_') || name.startsWith('TERRY_')
    || name.startsWith('KIM_') || name.startsWith('RYO_') || name.startsWith('LEONA_') || name.startsWith('SPECIAL_')) return 15;
  // Command normals
...
function getJuggleCost(attackType: AttackType): number {
  ...
  if (name.startsWith('KYO_') || name.startsWith('IORI_') || name.startsWith('TERRY_')
    || name.startsWith('KIM_') || name.startsWith('RYO_') || name.startsWith('LEONA_') || name.startsWith('SPECIAL_')) return JUGGLE_COST_SPECIAL;
