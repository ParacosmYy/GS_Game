...
export const MOVE_NAME_MAP: Partial<Record<AttackType, string>> = {
  ...
  [AttackType.RYO_TSURIZAO]: '冰柱割り',
  [AttackType.RYO_ORISHI]: '落蹴',
  ...
  [AttackType.KYO_ARAGAMI_KONOKIZU]: '九傷',
  [AttackType.KYO_ARAGAMI_YANOSABI]: '八錆',
  [AttackType.DM_OROCHINAGI]: '大蛇薙',
  [AttackType.SDM_OROCHINAGI]: '大蛇薙',
  [AttackType.HSDM_OROCHINAGI]: '大蛇薙',
  [AttackType.CMD_GOFU_YOU]: '轟斧陽',
  [AttackType.CMD_88SHIKI]: '八拾八式',
  [AttackType.CMD_NARAKU]: '奈落落とし',
  // Iori (八神庵)
  [AttackType.IORI_YAMIBARAI]: '闇払い',
  [AttackType.IORI_YAMIBARAI_C]: '闇払い',
  [AttackType.DM_YATAGARASU]: '八咫烏',
  [AttackType.SDM_YATAGARASU]: '八咫烏',
  [AttackType.HSDM_YAOTOME]: '八稚女',
  [AttackType.IORI_AOIHANA]: '葵花',
  [AttackType.IORI_AOIHANA_2]: '葵花',
  [AttackType.IORI_AOIHANA_3]: '葵花',
  [AttackType.IORI_AOIHANA_C]: '葵花',
  [AttackType.IORI_AOIHANA_C_2]: '葵花',
  [AttackType.IORI_AOIHANA_C_3]: '葵花',
  [AttackType.IORI_KOTOTSUKI]: '琴月陰',
  [AttackType.IORI_KOTOTSUKI_D]: '琴月陰',
  [AttackType.IORI_ONIYAKI]: '鬼焼き',
  [AttackType.IORI_ONIYAKI_C]: '鬼焼き',
  [AttackType.IORI_KUZUKAZE]: '屑風',
  [AttackType.IORI_YUMEYUMI]: '夢弾',
  [AttackType.IORI_KATANUGI]: '邯鄲',
  [AttackType.IORI_YUKIWARUI]: '百合折り',
  // Terry (テリー・ボガード)
