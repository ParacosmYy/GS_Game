/**
 * Heidern Cancel Paths — Cancel route matrix for Heidern
 *
 * Defines all cancel routes for Heidern's moveset:
...
// ===== Heidern Normal -> Special Cancel Routes =====

const HEIDERN_SPECIALS = [
...
const HEIDERN_NORMAL_TO_SPECIAL: CancelRoute[] = [
  // Far stand normals -> specials
  { from: 'STAND_A', to: [...HEIDERN_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'STAND_B', to: [...HEIDERN_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'STAND_C', to: [...HEIDERN_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'STAND_D', to: [...HEIDERN_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  // Close normals -> specials
  { from: 'CLOSE_A', to: [...HEIDERN_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CLOSE_B', to: [...HEIDERN_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CLOSE_C', to: [...HEIDERN_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CLOSE_D', to: [...HEIDERN_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  // Crouch normals -> specials
  { from: 'CROUCH_A', to: [...HEIDERN_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CROUCH_B', to: [...HEIDERN_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CROUCH_C', to: [...HEIDERN_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CROUCH_D', to: [...HEIDERN_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  // Command normals -> specials
  {
    from: 'HEIDERN_SLIDING', to: ['HEIDERN_CROSS_CUTTER', 'HEIDERN_CROSS_CUTTER_C', 'HEIDERN_MOON_SLASHER', 'HEIDERN_LEIDEN_REITTER'],
    cancelType: 'command', requiresHit: true, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL,
  },
  {
    from: 'HEIDERN_COMMAND_A', to: ['HEIDERN_CROSS_CUTTER', 'HEIDERN_MOON_SLASHER', 'HEIDERN_MOON_SLASHER_C', 'HEIDERN_STORMBRINGER'],
    cancelType: 'command', requiresHit: true, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL,
  },
];

// ===== Heidern Special -> Super (DM) Cancel Routes =====
...
const HEIDERN_SPECIAL_TO_DM: CancelRoute[] = HEIDERN_SPECIALS.map(src => ({
  from: src,
  to: [...HEIDERN_DMS],
  cancelType: 'super',
  requiresHit: true,
...
// ===== Heidern MAX Mode Free Cancel Routes =====

const HEIDERN_FREE_CANCEL: CancelRoute[] = HEIDERN_SPECIALS.map(src => ({
  from: src,
  to: HEIDERN_SPECIALS.filter(t => t !== src),
  cancelType: 'free',
  requiresHit: true,
  stockCost: 0,
...
const HEIDERN_RAPID_CANCEL: CancelRoute[] = [
...
export const HEIDERN_CANCEL_PATHS: CancelRoute[] = [
  ...HEIDERN_RAPID_CANCEL,
  ...HEIDERN_NORMAL_TO_SPECIAL,
  ...HEIDERN_SPECIAL_TO_DM,
  ...HEIDERN_FREE_CANCEL,
];
...
export function findCancelRoute(source: string, target: string): CancelRoute | null {
  for (const route of HEIDERN_CANCEL_PATHS) {
...
export function getCancelRoutesByType(cancelType: CancelType): CancelRoute[] {
  return HEIDERN_CANCEL_PATHS.filter(r => r.cancelType === cancelType);
}

export function isCancelSource(attackType: string): boolean {
  return HEIDERN_CANCEL_PATHS.some(r => r.from === attackType);
}
...
export function getBestCancelRoute(source: string, availableStocks: number, maxModeActive: boolean): CancelRoute | null {
  ...
  for (const type of priority) {
    const route = HEIDERN_CANCEL_PATHS.find(r =>
