...
const KYO_FREE_CANCEL: CancelRoute[] = [
  {
    from: 'KYO_ONIYAKI',
    to: ['KYO_YAMIBARAI', 'KYO_YAMIBARAI_C', 'KYO_RED_KICK', 'KYO_ONIYAKI_C', 'KYO_75KAI', 'KYO_ARAGAMI', 'KYO_DOKUGAMI'],
    cancelType: 'free',
    requiresHit: true,
    stockCost: 0,
  ...
  {
    from: 'KYO_ONIYAKI_C',
    to: ['KYO_YAMIBARAI', 'KYO_YAMIBARAI_C', 'KYO_RED_KICK', 'KYO_ONIYAKI', 'KYO_75KAI', 'KYO_ARAGAMI', 'KYO_DOKUGAMI'],
    cancelType: 'free',
    requiresHit: true,
    stockCost: 0,
    timerCost: FREE_CANCEL_TIMER_COST,
  ...
  {
    from: 'KYO_YAMIBARAI',
    to: ['KYO_ONIYAKI', 'KYO_ONIYAKI_C', 'KYO_RED_KICK', 'KYO_YAMIBARAI_C', 'KYO_75KAI', 'KYO_ARAGAMI', 'KYO_DOKUGAMI'],
    cancelType: 'free',
    requiresHit: true,
    stockCost: 0,
    timerCost: FREE_CANCEL_TIMER_COST,
  ...
  {
    from: 'KYO_YAMIBARAI_C',
    to: ['KYO_ONIYAKI', 'KYO_ONIYAKI_C', 'KYO_RED_KICK', 'KYO_YAMIBARAI', 'KYO_75KAI', 'KYO_ARAGAMI', 'KYO_DOKUGAMI'],
    cancelType: 'free',
    requiresHit: true,
    stockCost: 0,
    timerCost: FREE_CANCEL_TIMER_COST,
  ...
  {
    from: 'KYO_RED_KICK',
    to: ['KYO_ONIYAKI', 'KYO_ONIYAKI_C', 'KYO_YAMIBARAI', 'KYO_YAMIBARAI_C', 'KYO_75KAI', 'KYO_ARAGAMI', 'KYO_DOKUGAMI'],
    cancelType: 'free',
    requiresHit: true,
    stockCost: 0,
    timerCost: FREE_CANCEL_TIMER_COST,
  ...
  {
    from: 'KYO_75KAI',
    to: ['KYO_ONIYAKI', 'KYO_ONIYAKI_C', 'KYO_YAMIBARAI', 'KYO_YAMIBARAI_C', 'KYO_RED_KICK', 'KYO_ARAGAMI', 'KYO_DOKUGAMI'],
    cancelType: 'free',
    requiresHit: true,
    stockCost: 0,
    timerCost: FREE_CANCEL_TIMER_COST,
  ...
  // Aragami rekka chain — free cancel from any part to other specials
  {
    from: 'KYO_ARAGAMI',
    to: ['KYO_ONIYAKI', 'KYO_ONIYAKI_C', 'KYO_YAMIBARAI', 'KYO_YAMIBARAI_C', 'KYO_RED_KICK', 'KYO_DOKUGAMI', 'KYO_75KAI'],
    cancelType: 'free',
    requiresHit: true,
    stockCost: 0,
    timerCost: FREE_CANCEL_TIMER_COST,
  ...
  {
    from: 'KYO_ARAGAMI_KONOKIZU',
    to: ['KYO_ONIYAKI', 'KYO_ONIYAKI_C', 'KYO_YAMIBARAI', 'KYO_YAMIBARAI_C', 'KYO_RED_KICK', 'KYO_DOKUGAMI'],
    cancelType: 'free',
    requiresHit: true,
    stockCost: 0,
    timerCost: FREE_CANCEL_TIMER_COST,
  ...
  // Dokugami rekka chain — free cancel from any part to other specials
  {
    from: 'KYO_DOKUGAMI',
    to: ['KYO_ONIYAKI', 'KYO_ONIYAKI_C', 'KYO_YAMIBARAI', 'KYO_YAMIBARAI_C', 'KYO_RED_KICK', 'KYO_ARAGAMI', 'KYO_75KAI'],
    cancelType: 'free',
    requiresHit: true,
    stockCost: 0,
    timerCost: FREE_CANCEL_TIMER_COST,
  ...
  {
    from: 'KYO_TSUMIYOMI',
    to: ['KYO_ONIYAKI', 'KYO_ONIYAKI_C', 'KYO_YAMIBARAI', 'KYO_YAMIBARAI_C', 'KYO_RED_KICK', 'KYO_ARAGAMI'],
    cancelType: 'free',
    requiresHit: true,
    stockCost: 0,
    timerCost: FREE_CANCEL_TIMER_COST,
