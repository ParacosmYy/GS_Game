/**
 * Kim Cancel Paths — Cancel route matrix for Kim Kaphwan
 *
 * Defines all cancel routes for Kim's moveset:
 * - Normal -> Special cancels
 * - Rapid cancel chains (light normals)
 * - Rekka followup chains (Sanren 3-hit series)
 ...
 * - Rekka: Sanren Geki followup hits reuse same AttackType
 */
import {
...
// ===== Kim Normal -> Special Cancel Routes =====
...
const KIM_NORMAL_TO_SPECIAL: CancelRoute[] = [
  // Far stand normals -> specials
  { from: 'STAND_A', to: [...KIM_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'STAND_B', to: [...KIM_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'STAND_C', to: [...KIM_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'STAND_D', to: [...KIM_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  // Close normals -> specials
  { from: 'CLOSE_A', to: [...KIM_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CLOSE_B', to: [...KIM_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CLOSE_C', to: [...KIM_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CLOSE_D', to: [...KIM_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  // Crouch normals -> specials
  { from: 'CROUCH_A', to: [...KIM_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CROUCH_B', to: [...KIM_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CROUCH_C', to: [...KIM_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CROUCH_D', to: [...KIM_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  // Command normals -> specials
  {
    from: 'KIM_HISHOU_KICK', to: ['KIM_HIENZAN', 'KIM_HIENZAN_D', 'KIM_HANGETSU'],
    cancelType: 'command', requiresHit: true, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL,
  },
  {
    from: 'KIM_HANSEN', to: ['KIM_HIENZAN', 'KIM_HIENZAN_D', 'KIM_HANGETSU'],
    cancelType: 'command', requiresHit: true, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL,
  },
];

// ===== Kim Rekka Followup (Sanren 3-hit) =====

const KIM_REKKA_CHAINS: CancelRoute[] = [
  {
    from: 'KIM_SANREN', to: ['KIM_SANREN'],
    cancelType: 'rekka', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: 20,
  },
];

// ===== Kim Special -> Super (DM) Cancel Routes =====

const KIM_DMS = ['DM_PHOENIX_KICK', 'DM_PHOENIX_HITEN', 'SDM_PHOENIX_HITEN'];

const KIM_SPECIAL_TO_DM: CancelRoute[] = KIM_SPECIALS.map(src => ({
  from: src,
  to: [...KIM_DMS],
  cancelType: 'super',
  requiresHit: true,
...
// ===== Kim MAX Mode Free Cancel Routes =====

const KIM_FREE_CANCEL: CancelRoute[] = KIM_SPECIALS.map(src => ({
  from: src,
  to: KIM_SPECIALS.filter(t => t !== src),
  cancelType: 'free',
  requiresHit: true,
  stockCost: 0,
...
const KIM_RAPID_CANCEL: CancelRoute[] = [
...
export const KIM_CANCEL_PATHS: CancelRoute[] = [
  ...KIM_RAPID_CANCEL,
  ...KIM_REKKA_CHAINS,
  ...KIM_NORMAL_TO_SPECIAL,
  ...KIM_SPECIAL_TO_DM,
  ...KIM_FREE_CANCEL,
];
...
export function findCancelRoute(source: string, target: string): CancelRoute | null {
  for (const route of KIM_CANCEL_PATHS) {
...
export function getCancelRoutesByType(cancelType: CancelType): CancelRoute[] {
  return KIM_CANCEL_PATHS.filter(r => r.cancelType === cancelType);
}

export function isCancelSource(attackType: string): boolean {
  return KIM_CANCEL_PATHS.some(r => r.from === attackType);
}
...
export function getBestCancelRoute(source: string, availableStocks: number, maxModeActive: boolean): CancelRoute | null {
  ...
  for (const type of priority) {
    const route = KIM_CANCEL_PATHS.find(r =>
