...
export const G_RUGAL_MOVES: MoveDefinition[] = [
  ...
  { key: 'G_RUGAL_KAISER_WAVE', nameJa: 'Kaiser Wave', nameEn: 'Kaiser Wave', category: 'special', input: 'quarter-circle forward + A / C', versions: [{ version: 'A', attackTypeKey: 'G_RUGAL_KAISER_WAVE', differences: 'MUGEN action 1100 projectile startup', damageMultiplier: 1.15, knockdown: false, invincibleStartup: 0, isProjectile: true }] },
  { key: 'G_RUGAL_REPPU_KEN', nameJa: 'Reppu Ken', nameEn: 'Reppu Ken', category: 'special', input: 'quarter-circle back + A / C', versions: [{ version: 'A', attackTypeKey: 'G_RUGAL_REPPU_KEN', differences: 'MUGEN action 1200 slash wave', damageMultiplier: 1.1, knockdown: true, invincibleStartup: 0, isProjectile: true }] },
  { key: 'G_RUGAL_GENOCIDE_CUTTER', nameJa: 'Genocide Cutter', nameEn: 'Genocide Cutter', category: 'special', input: 'dragon-punch + B / D', versions: [{ version: 'B', attackTypeKey: 'G_RUGAL_GENOCIDE_CUTTER', differences: 'MUGEN action 1400 anti-air kick', damageMultiplier: 1.25, knockdown: true, invincibleStartup: 3, isProjectile: false }] },
