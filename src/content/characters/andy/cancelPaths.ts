/**
 * Andy Cancel Paths — Cancel route matrix for Andy Bogard
 *
 * Defines all cancel routes for Andy's moveset:
 ...
 *
 * Andy is a rushdown/shoto character: strong projectile game (Hishou Ken),
 * reliable anti-air (Shouryuu Dan), and advancing attacks (Zan'ei Ryuusei Ken).
 * His cancel routes emphasize projectile zoning into rush pressure.
 */
import {
...
// ===== Andy Normal -> Special Cancel Routes =====
...
const ANDY_NORMAL_TO_SPECIAL: CancelRoute[] = [
  // Far stand normals -> specials
  { from: 'STAND_A', to: [...ANDY_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'STAND_B', to: [...ANDY_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'STAND_C', to: [...ANDY_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'STAND_D', to: [...ANDY_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  // Close normals -> specials
  { from: 'CLOSE_A', to: [...ANDY_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CLOSE_B', to: [...ANDY_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CLOSE_C', to: [...ANDY_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CLOSE_D', to: [...ANDY_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  // Crouch normals -> specials
  { from: 'CROUCH_A', to: [...ANDY_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CROUCH_B', to: [...ANDY_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CROUCH_C', to: [...ANDY_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CROUCH_D', to: [...ANDY_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  // Command normals -> specials
  {
    from: 'ANDY_UWA_AGITO', to: ['ANDY_HISHOU_KEN', 'ANDY_HISHOU_KEN_C', 'ANDY_SHOURYUU_DAN', 'ANDY_SHOURYUU_DAN_C'],
    cancelType: 'command', requiresHit: true, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL,
  },
  {
    from: 'ANDY_GEDAN_AGITO', to: ['ANDY_ZANEI_RYUSEI_KEN', 'ANDY_ZANEI_RYUSEI_KEN_D', 'ANDY_SHOURYUU_DAN'],
    cancelType: 'command', requiresHit: true, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL,
  },
];

// ===== Andy Special -> Super (DM) Cancel Routes =====

const ANDY_DMS = ['DM_CHO_REPPA_DAN'];

const ANDY_SPECIAL_TO_DM: CancelRoute[] = ANDY_SPECIALS.map(src => ({
  from: src,
  to: [...ANDY_DMS],
  cancelType: 'super',
  requiresHit: true,
...
// ===== Andy MAX Mode Free Cancel Routes =====

const ANDY_FREE_CANCEL: CancelRoute[] = ANDY_SPECIALS.map(src => ({
  from: src,
  to: ANDY_SPECIALS.filter(t => t !== src),
  cancelType: 'free',
  requiresHit: true,
  stockCost: 0,
...
const ANDY_RAPID_CANCEL: CancelRoute[] = [
...
export const ANDY_CANCEL_PATHS: CancelRoute[] = [
  ...ANDY_RAPID_CANCEL,
  ...ANDY_NORMAL_TO_SPECIAL,
  ...ANDY_SPECIAL_TO_DM,
  ...ANDY_FREE_CANCEL,
];
...
export function findCancelRoute(source: string, target: string): CancelRoute | null {
  for (const route of ANDY_CANCEL_PATHS) {
...
export function getCancelRoutesByType(cancelType: CancelType): CancelRoute[] {
  return ANDY_CANCEL_PATHS.filter(r => r.cancelType === cancelType);
}

export function isCancelSource(attackType: string): boolean {
  return ANDY_CANCEL_PATHS.some(r => r.from === attackType);
}
...
export function getBestCancelRoute(source: string, availableStocks: number, maxModeActive: boolean): CancelRoute | null {
  ...
  for (const type of priority) {
    const route = ANDY_CANCEL_PATHS.find(r =>
