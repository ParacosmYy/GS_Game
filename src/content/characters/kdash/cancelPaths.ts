/**
 * K' Cancel Paths — Cancel route matrix for K'
 *
 * Defines all cancel routes for K''s moveset:
 ...
 *
 * K' is a rushdown/poke character with fire projectiles (Eins Trigger),
 * rising uppercuts (Crow Bites), and overhead/low mixups.
 * His cancel routes emphasize projectile pressure and mid-range footsies.
 */
import {
...
// ===== K' Normal -> Special Cancel Routes =====

const KDASH_SPECIALS = [
  'KDASH_EINS', 'KDASH_EINS_C',
  'KDASH_CROW', 'KDASH_CROW_C',
  'KDASH_MINUTE', 'KDASH_NARROW',
];

const KDASH_NORMAL_TO_SPECIAL: CancelRoute[] = [
  // Far stand normals -> specials
  { from: 'STAND_A', to: [...KDASH_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'STAND_B', to: [...KDASH_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'STAND_C', to: [...KDASH_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'STAND_D', to: [...KDASH_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  // Close normals -> specials
  { from: 'CLOSE_A', to: [...KDASH_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CLOSE_B', to: [...KDASH_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CLOSE_C', to: [...KDASH_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CLOSE_D', to: [...KDASH_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  // Crouch normals -> specials
  { from: 'CROUCH_A', to: [...KDASH_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CROUCH_B', to: [...KDASH_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CROUCH_C', to: [...KDASH_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  { from: 'CROUCH_D', to: [...KDASH_SPECIALS], cancelType: 'normal', requiresHit: false, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL },
  // Command normals -> specials
  {
    from: 'KDASH_ONE_INCH', to: ['KDASH_EINS', 'KDASH_EINS_C', 'KDASH_CROW', 'KDASH_CROW_C', 'KDASH_MINUTE'],
    cancelType: 'command', requiresHit: true, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL,
  },
  {
    from: 'KDASH_TRIGGER', to: ['KDASH_NARROW', 'KDASH_CROW', 'KDASH_CROW_C'],
    cancelType: 'command', requiresHit: true, stockCost: 0, timerCost: 0, windowFrames: CANCEL_WINDOW_NORMAL,
  },
];

// ===== K' Special -> Super (DM) Cancel Routes =====

const KDASH_DMS = ['DM_CHAIN_SHOT', 'SDM_CHAIN_SHOT'];

const KDASH_SPECIAL_TO_DM: CancelRoute[] = KDASH_SPECIALS.map(src => ({
  from: src,
  to: [...KDASH_DMS],
  cancelType: 'super',
  requiresHit: true,
...
// ===== K' MAX Mode Free Cancel Routes =====

const KDASH_FREE_CANCEL: CancelRoute[] = KDASH_SPECIALS.map(src => ({
  from: src,
  to: KDASH_SPECIALS.filter(t => t !== src),
  cancelType: 'free',
  requiresHit: true,
  stockCost: 0,
...
const KDASH_RAPID_CANCEL: CancelRoute[] = [
...
export const KDASH_CANCEL_PATHS: CancelRoute[] = [
  ...KDASH_RAPID_CANCEL,
  ...KDASH_NORMAL_TO_SPECIAL,
  ...KDASH_SPECIAL_TO_DM,
  ...KDASH_FREE_CANCEL,
];
...
export function findCancelRoute(source: string, target: string): CancelRoute | null {
  for (const route of KDASH_CANCEL_PATHS) {
...
export function getCancelRoutesByType(cancelType: CancelType): CancelRoute[] {
  return KDASH_CANCEL_PATHS.filter(r => r.cancelType === cancelType);
}

export function isCancelSource(attackType: string): boolean {
  return KDASH_CANCEL_PATHS.some(r => r.from === attackType);
}
...
export function getBestCancelRoute(source: string, availableStocks: number, maxModeActive: boolean): CancelRoute | null {
  ...
  for (const type of priority) {
    const route = KDASH_CANCEL_PATHS.find(r =>
