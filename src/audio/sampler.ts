...
// DSP primitives (renderOsc, renderNoise, lowPass, highPass, bandPass,
// mixLayers, normalize, expDecay, padTo, clamp) are imported from
// ./samplerRenderUtils.ts so character content packages can share them.
